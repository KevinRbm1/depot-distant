        ...
        <header>
            ...
            <nav class="header navbar navbar-expand-lg bg-dark">
                ...
                <div class="container-fluid">
                    <a class="col-9 navbar-brand text-light mx-2" href="index.php"><img src="../../img/logotype/vr.png" alt="logo de Velvet record" width="auto" height="24" class=""> Velvet Record</a>
                    ...
                    if (isset($_SESSION["login"]) && $_SESSION["login"] != "") { ?>
                        <span class="fst-bold">Bienvenue <?= $_SESSION["login"] ?>
                            <a href="script_logout.php" title="fermeture de la session" alt="Fermer la session"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-box-arrow-right text-danger mx-3" viewBox="0 0 16 16">
